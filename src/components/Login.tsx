...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-zinc-900 via-black to-zinc-900 subtle-bg-animation">
      <div className="w-full max-w-md p-8 bg-zinc-900/90 backdrop-blur-md rounded-xl border border-zinc-800 auth-form-glow shadow-2xl shadow-purple-900/10 transition-all duration-300 hover:shadow-purple-800/20 relative overflow-hidden animate-slide-up">
        <div className="absolute inset-0 bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-purple-900/5 via-zinc-900/5 to-purple-900/10 opacity-50"></div>
        ...
        <div className="relative z-10 mb-8">
          ...
          <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-400 text-center">Sign in to Glyssa</h1>
          <p className="mt-2 text-zinc-400 text-center">
            Access your AI-powered code analysis tools
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="mt-1 block w-full pl-10 px-4 py-3 bg-zinc-800/80 border border-zinc-700 rounded-lg shadow-sm 
          ...
          <div className="flex items-center justify-between mt-6">
            <div className="flex items-center">
              <div className="relative inline-flex items-center">
                ...
                />
                <svg className="absolute w-3 h-3 text-white pointer-events-none opacity-0 peer-checked:opacity-100 transform scale-50 peer-checked:scale-100 transition-transform duration-100" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" style={{ left: '0.25rem' }}>
